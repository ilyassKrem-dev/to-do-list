        ...
        <>
            <div className='flex flex-col mx-3 md:mx-0 mt-5'>
                    <div className='flex items-start bg-[#262626] border border-[#333] w-full p-4 rounded-lg '>
                        ...
                        <p className={`mr-10 ml-3 flex-1 -translate-y-[0.2rem] ${props.addTask.checked ? "line-through text-[#808080]":"text-white"}`}>{props.addTask.task}</p>
                
                        <Image className='w-3 h-3 sm:w-4 sm:h-4 cursor-pointer' src={trashsvg} alt="" />
